...
| [`lgtm-presentation`](../skills/lgtm-presentation/SKILL.md) | Build polished, Red Hat-branded 16:9 technical slide decks (.pptx) programmatically with pptxgenjs, in the house style of the "Designing Cloud-Native APIs" / "API Patterns and Practices" series — Overpass / Red Hat Text / Red Hat Mono fonts, red #EE0000 accents, a custom cover, textured section dividers, the Red Hat logo on every slide, thick speaker notes, status-code / reference tables, dark code slides, and matching SVG + Excalidraw + PNG diagrams from a Python Scene engine. |
